...
plot_list = [df_shake_k2['gen_a'],df_forro_k2['gen_a'],df_xote_k2['gen_a']]
...
plt.xticks([1, 2, 3], ['SHAKE', 'FORRO', 'XOTE'])
...
plot_list = [df_shake_k2['keypair'],df_forro_k2['keypair'],df_xote_k2['keypair']]
plt.figure(figsize =(11, 6))
bplots = plt.boxplot(plot_list,  vert = 1, patch_artist = False)
# Adicionando Título ao gráfico
...
plot_list = [df_shake_k2['encaps'],df_forro_k2['encaps'],df_xote_k2['encaps']]
plt.figure(figsize =(11, 6))
bplots = plt.boxplot(plot_list,  vert = 1, patch_artist = False)
# Adicionando Título ao gráfico
...
plot_list = [df_shake_k2['decaps'],df_forro_k2['decaps'],df_xote_k2['decaps']]
plt.figure(figsize =(11, 6))
bplots = plt.boxplot(plot_list,  vert = 1, patch_artist = False)
# Adicionando Título ao gráfico
...
plot_list = [df_shake_k3['gen_a'],df_forro_k3['gen_a'],df_xote_k3['gen_a']]
plt.figure(figsize =(11, 6))
bplots = plt.boxplot(plot_list,  vert = 1, patch_artist = False)
# Adicionando Título ao gráfico
plt.title("Boxplot gen_a", loc="center", fontsize=18)
...
plot_list = [df_shake_k3['keypair'],df_forro_k3['keypair'],df_xote_k3['keypair']]
plt.figure(figsize =(11, 6))
bplots = plt.boxplot(plot_list,  vert = 1, patch_artist = False)
# Adicionando Título ao gráfico
plt.title("Boxplot Keygen", loc="center", fontsize=18)
...
plot_list = [df_shake_k3['encaps'],df_forro_k3['encaps'],df_xote_k3['encaps']]
plt.figure(figsize =(11, 6))
bplots = plt.boxplot(plot_list,  vert = 1, patch_artist = False)
# Adicionando Título ao gráfico
plt.title("Boxplot Encaps", loc="center", fontsize=18)
...
plot_list = [df_shake_k3['decaps'],df_forro_k3['decaps'],df_xote_k3['decaps']]
plt.figure(figsize =(11, 6))
bplots = plt.boxplot(plot_list,  vert = 1, patch_artist = False)
# Adicionando Título ao gráfico
plt.title("Boxplot Decaps", loc="center", fontsize=18)
...
plot_list = [df_shake_k4['gen_a'],df_forro_k4['gen_a'],df_xote_k4['gen_a']]
plt.figure(figsize =(11, 6))
bplots = plt.boxplot(plot_list,  vert = 1, patch_artist = False)
# Adicionando Título ao gráfico
plt.title("Boxplot gen_a", loc="center", fontsize=18)
...
plot_list = [df_shake_k4['keypair'],df_forro_k4['keypair'],df_xote_k4['keypair']]
plt.figure(figsize =(11, 6))
bplots = plt.boxplot(plot_list,  vert = 1, patch_artist = False)
# Adicionando Título ao gráfico
plt.title("Boxplot Keygen", loc="center", fontsize=18)
...
plot_list = [df_shake_k4['encaps'],df_forro_k4['encaps'],df_xote_k4['encaps']]
plt.figure(figsize =(11, 6))
bplots = plt.boxplot(plot_list,  vert = 1, patch_artist = False)
# Adicionando Título ao gráfico
plt.title("Boxplot Encaps", loc="center", fontsize=18)
...
plot_list = [df_shake_k4['decaps'],df_forro_k4['decaps'],df_xote_k4['decaps']]
plt.figure(figsize =(11, 6))
bplots = plt.boxplot(plot_list,  vert = 1, patch_artist = False)
# Adicionando Título ao gráfico
plt.title("Boxplot Decaps", loc="center", fontsize=18)
