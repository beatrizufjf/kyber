...
//#define forro_prf KYBER_NAMESPACE(_forro_prf)
//void forro_prf(uint8_t *out,
//                        size_t outlen,
//                        const uint8_t key[KYBER_SYMBYTES],
//                      uint8_t nonce);
...
//#define xof_absorb(STATE, SEED, X, Y) forro_absorb(STATE, SEED, X, Y)
#define xof_absorb(STATE, SEED, X, Y) forro_absorb(STATE, (uint8_t *)SEED, X, Y) //MUDANCA
...
#define hash_g(OUT, IN, INBYTES) sha3_512(OUT, IN, INBYTES)
//#define xof_absorb(STATE, SEED, X, Y) forro_absorb(STATE, SEED, X, Y)
#if IMPLEMENTATION == FORRO
#define xof_absorb(STATE, SEED, X, Y) forro_absorb(STATE, SEED, X, Y) //MUDANCA
